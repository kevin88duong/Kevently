...
export default async function Home({searchParams}:SearchParamProps) {
  ...
  return (
    ...
    <section id="events" className='wrapper my-8 flex flex-col gap-8 md:gap-12'>
      ...
      <Collection data={events?.data} emptyTitle="No events found" emptySubtext="Come back later" collectionType="All_Events" limit={6} page={page} totalPages={events?.totalPages} />
    </section>
    </>
  )
}
