...
const EventDetails = async({params:{id}, searchParams}:SearchParamProps) => {
  ...
  //Event details page, displaying all the infomation about an event from the database
  return (
    <>
        ...
        <div className="flex w-full flex-col p-5 gap-8 md:p-10">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex gap-2 md:gap-3">
              <Image src="/assets/icons/calendar.svg" alt="" width={32} height={32} />
              <div className="p-medium-16 lg:p-regular-20 flex flex-wrap items-center">
                <p >
                  {formatDateTime(event.startDateTime).dateOnly} - {" "}
                  {formatDateTime(event.startDateTime).timeOnly} To
                </p>
                <p className="2xl:ml-1">
            ...
            <div className="p-regular-20 flex items-center gap-3">  
              <Image src="/assets/icons/location.svg" alt="" width={32} height={32}/>
